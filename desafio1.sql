DROP DATABASE IF EXISTS SpotifyClone;
  ...
  CREATE TABLE SpotifyClone.tipos_plano(
  ...
  CREATE TABLE SpotifyClone.usuarios(
      ...
      FOREIGN KEY (plano_id) REFERENCES SpotifyClone.tipos_plano (plano_id)
  ) engine = InnoDB;
  ...
  INSERT INTO SpotifyClone.tipos_plano (plano_id, nome_plano, valor_plano)
  VALUES
    (1, 'gratuito', 0.00),
  ...
  INSERT INTO SpotifyClone.usuarios (usuario_id, nome_usuario, idade, plano_id, data_assinatura)
  VALUES
  ...
  INSERT INTO SpotifyClone.albuns (album_id, nome_album, ano_lancamento, artista_id)
  VALUES
  ...
  INSERT INTO SpotifyClone.cancoes (cancao_id, nome_cancao, duracao_segundos, album_id)
  VALUES
  ...
  INSERT INTO SpotifyClone.historico_reproducoes (cancao_id, data_reproducao, usuario_id)
  VALUES
